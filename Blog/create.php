...
<body>
   ...
   <div class="container mt-5">
        ...
        <div class = "navbar justify-content-between">
            <div id = "left_side">
            <a href="index.php"   class="btn btn-dark text-white btn-outline-dark my-3" >Home</a>
            </div>
        ...
        <form method="POST">
            ...
            <textarea name="content" class="form-control my-3 bg-white text-darl" cols="30" rows="10"></textarea>
